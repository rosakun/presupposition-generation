import spacy
from hilfsfunktionen import starts_with_vowel, regular_plural, generate_subject, generate_pp, generate_advmod, generate_attr, generate_ccomp, generate_np, generate_poss, generate_prt, generate_vp, generate_xcomp
import re

"""
This function handles the generation of a presupposition triggered by a relative clause.
